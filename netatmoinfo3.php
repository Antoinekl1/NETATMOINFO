...
* From Netatmo API
* V2 : ajout DASHBORD + 3 thermostats
*/ 
...
{	
	...
	$username = '';
	$password = '';
	echo '<form action="http://www.histoires2familles.fr/netatmoinfo3.php" method="get" accept-charset="utf-8" id="form-login">';
...
$url_site='http://www.histoires2familles.fr/netatmoinfo3.php?mail='.$username.'&pass='.$password;
...
// Thermostat3
$name_therm3 = $data_therm['body']['modules'][2]['module_name'];
$mac_therm3 = $data_therm['body']['modules'][2]['_id'];
$type_therm3 = $data_therm['body']['modules'][2]['type'];
$temp_therm3 = $data_therm['body']['modules'][2]['dashboard_data']['Temperature'];
$mintemp_therm3 = $data_therm['body']['modules'][2]['dashboard_data']['min_temp'];
$maxtemp_therm3 = $data_therm['body']['modules'][2]['dashboard_data']['max_temp'];
$datemintemp_therm3 = $data_therm['body']['modules'][2]['dashboard_data']['date_min_temp'];
$datemaxtemp_therm3 = $data_therm['body']['modules'][2]['dashboard_data']['date_max_temp'];
$battery_therm3 = $data_therm['body']['modules'][2]['battery_vp'];
$statusrf_therm3 = $data_therm['body']['modules'][2]['rf_status'];
$firmware_therm3 = $data_therm['body']['modules'][2]['firmware'];
$orientation_therm3 = $data_therm['body']['modules'][2]['therm_orientation'];
$etat_therm3 = $data_therm['body']['modules'][2]['therm_relay_cmd'];
...
// Relai3
$name_relai3 = $data_therm['body']['devices'][2]['station_name'];
$mac_relai3 = $data_therm['body']['devices'][2]['_id'];
$type_relai3 = $data_therm['body']['devices'][2]['type'];
$firmware_relai3 = $data_therm['body']['devices'][2]['firmware'];
$wifi_relai3 = $data_therm['body']['devices'][2]['wifi_status'];
$refmod1_relai3 = $data_therm['body']['devices'][2]['modules'][0];
$refmod2_relai3 = $data_therm['body']['devices'][2]['modules'][1];
$refmod3_relai3 = $data_therm['body']['devices'][2]['modules'][2];
$refmac_relai3 = $data_therm['body']['devices'][2]['house_model']['link_station']['mac'];
$refext_relai3 = $data_therm['body']['devices'][2]['house_model']['link_station']['ext'];
$reftemp_relai3 = $data_therm['body']['devices'][2]['house_model']['link_station']['Temperature'];
...
if ( $mode == 'dashbord') {
	...
	echo '<td align=center>'.NAImgorientation($orientation_therm1).'</td>';
	echo '<td align=center>'.NAImgorientation($orientation_therm2).'</td>';
	echo '<td align=center>'.NAImgorientation($orientation_therm3).'</td>';
	echo '</tr>';
	echo '<tr>';
	...
	echo '<td align=center width=15%>'.$name_therm1.'<br />('.$mac_therm1.')</td>';
	echo '<td align=center width=15%>'.$name_therm2.'<br />('.$mac_therm2.')</td>';
	echo '<td align=center width=15%>'.$name_therm2.'<br />('.$mac_therm3.')</td>';
	echo '</tr>';
	echo '<tr>';
	...
	echo '<td align=center>'.$temp_therm1.'°</td>';
	echo '<td align=center>'.$temp_therm2.'°</td>';	
	echo '<td align=center>'.$temp_therm3.'°</td>';	
	echo '</tr>';
	echo '<tr>';
	...
	echo '<td align=center>'.$mintemp_therm1.'</b>° à '.date('H:i',$datemintemp_therm1).'</td>';
	echo '<td align=center>'.$mintemp_therm2.'</b>° à '.date('H:i',$datemintemp_therm2).'</td>';
	echo '<td align=center>'.$mintemp_therm3.'</b>° à '.date('H:i',$datemintemp_therm3).'</td>';
	echo '</tr>';
	echo '<tr>';
	...
	echo '<td align=center>'.$maxtemp_therm1.'</b>° à '.date('H:i',$datemaxtemp_therm1).'</td>';
	echo '<td align=center>'.$maxtemp_therm2.'</b>° à '.date('H:i',$datemaxtemp_therm2).'</td>';
	echo '<td align=center>'.$maxtemp_therm3.'</b>° à '.date('H:i',$datemaxtemp_therm3).'</td>';
	echo '</tr>';
	echo '<tr>';
	...
	echo '<td align=left><ul>';
	echo '<li>Orientation : <b>'.NAorientation($orientation_therm1).'</b></li>';
	echo '<li>Etat de la demande de chauffage : <b>'.NAetat($etat_therm1).'</b></li>';
	echo '</ul></td>';
	echo '<td align=left><ul>';
	echo '<li>Orientation : <b>'.NAorientation($orientation_therm2).'</b></li>';
	echo '<li>Etat de la demande de chauffage : <b>'.NAetat($etat_therm2).'</b></li>';
	echo '</ul></td>';
	echo '<td align=left><ul>';
	echo '<li>Orientation : <b>'.NAorientation($orientation_therm3).'</b></li>';
	echo '<li>Etat de la demande de chauffage : <b>'.NAetat($etat_therm3).'</b></li>';
	echo '</ul></td>';
	echo '</tr>';
	echo '<tr>';
	...
	echo '<td align=center>'.NABatteryLevelThermostat($battery_therm1).'</td>';
	echo '<td align=center>'.NABatteryLevelThermostat($battery_therm2).'</td>';	
	echo '<td align=center>'.NABatteryLevelThermostat($battery_therm3).'</td>';	
	echo '</tr>';
	echo '<tr>';
	...
	echo '<td align=center>'.NARadioRssiTreshold($statusrf_therm1).'</td>';
	echo '<td align=center>'.NARadioRssiTreshold($statusrf_therm2).'</td>';
	echo '<td align=center>'.NARadioRssiTreshold($statusrf_therm3).'</td>';
	echo '</tr>';
	echo '</tr>';
	echo '<tr>';
	...
	echo '<td align=center>'.$firmware_therm1.'</td>';
	echo '<td align=center>'.$firmware_therm2.'</td>';
	echo '<td align=center>'.$firmware_therm3.'</td>';
	echo '</tr>';
	echo '</table></center>';
}
...
// Thermostat 1
echo '<h1>'.$name_therm1.' ('.$mac_therm1.') : </h1>';
echo '<table width=90%><tr><td width=100>';
echo NAImgorientation($orientation_therm1);
echo '</td><td>';
echo '<ul>';
echo '<li>Température : <b>'.$temp_therm1.'</b> degrés</li>';
echo '<li>Température Min : <b>'.$mintemp_therm1.'</b> degrés à '.date('H:i',$datemintemp_therm1).' le '.date('d/m/Y',$datemintemp_therm1).'</li>';
echo '<li>Température Max : <b>'.$maxtemp_therm1.'</b> degrés à '.date('H:i',$datemaxtemp_therm1).' le '.date('d/m/Y',$datemaxtemp_therm1).'</li>';
echo '<li>Niveau batterie : <b>'.NABatteryLevelThermostat($battery_therm1).'</b> ('.$battery_therm1.')</li>';
echo '<li>Status radio : <b>'.NARadioRssiTreshold($statusrf_therm1).'</b> ('.$statusrf_therm1.')</li>';
echo '<li>Firmware : <b>'.$firmware_therm1.'</b></li>';
echo '<li>Orientation : <b>'.NAorientation($orientation_therm1).'</b></li>';
echo '<li>Etat de la demande de chauffage : <b>'.NAetat($etat_therm1).'</b></li>';
echo '</ul>';
echo '</td></tr></table>';
...
// Thermostat 2
echo '<h1>'.$name_therm2.' ('.$mac_therm2.') : </h1>';
echo '<table width=90%><tr><td width=100>';
echo NAImgorientation($orientation_therm2);
echo '</td><td>';
echo '<ul>';
echo '<li>Température : <b>'.$temp_therm2.'</b> degrés</li>';
echo '<li>Température Min : <b>'.$mintemp_therm2.'</b> degrés à '.date('H:i',$datemintemp_therm2).' le '.date('d/m/Y',$datemintemp_therm2).'</li>';
echo '<li>Température Max : <b>'.$maxtemp_therm2.'</b> degrés à '.date('H:i',$datemaxtemp_therm2).' le '.date('d/m/Y',$datemaxtemp_therm2).'</li>';
echo '<li>Niveau batterie : <b>'.NABatteryLevelThermostat($battery_therm2).'</b> ('.$battery_therm2.')</li>';
echo '<li>Status radio : <b>'.NARadioRssiTreshold($statusrf_therm2).'</b> ('.$statusrf_therm2.')</li>';
echo '<li>Firmware : <b>'.$firmware_therm2.'</b></li>';
echo '<li>Orientation : <b>'.NAorientation($orientation_therm2).'</b></li>';
echo '<li>Etat de la demande de chauffage : <b>'.NAetat($etat_therm2).'</b></li>';
echo '</ul>';
echo '</td></tr></table>';
...
// Thermostat 3
echo '<h1>'.$name_therm3.' ('.$mac_therm3.') : </h1>';
echo '<table width=90%><tr><td width=100>';
echo NAImgorientation($orientation_therm3);
echo '</td><td>';
echo '<ul>';
echo '<li>Température : <b>'.$temp_therm3.'</b> degrés</li>';
echo '<li>Température Min : <b>'.$mintemp_therm3.'</b> degrés à '.date('H:i',$datemintemp_therm3).' le '.date('d/m/Y',$datemintemp_therm3).'</li>';
echo '<li>Température Max : <b>'.$maxtemp_therm3.'</b> degrés à '.date('H:i',$datemaxtemp_therm3).' le '.date('d/m/Y',$datemaxtemp_therm3).'</li>';
echo '<li>Niveau batterie : <b>'.NABatteryLevelThermostat($battery_therm3).'</b> ('.$battery_therm3.')</li>';
echo '<li>Status radio : <b>'.NARadioRssiTreshold($statusrf_therm3).'</b> ('.$statusrf_therm3.')</li>';
echo '<li>Firmware : <b>'.$firmware_therm3.'</b></li>';
echo '<li>Orientation : <b>'.NAorientation($orientation_therm3).'</b></li>';
echo '<li>Etat de la demande de chauffage : <b>'.NAetat($etat_therm3).'</b></li>';
echo '</ul>';
echo '</td></tr></table>';
...
// Relai 1
echo '<h1>'.$name_relai1.' ('.$mac_relai1.') : </h1>';
echo '<table width=90%><tr><td width=100>';
echo '<img src=./'.$type_relai1.' width=100 />';
echo '</td><td>';
echo '<ul>';
echo '<li>Status Wifi : <b>'.NAWifiRssiThreshold($wifi_relai1).'</b> ('.$wifi_relai1.')</li>';
echo '<li>Firmware : <b>'.$firmware_relai1.'</b></li>';
echo '<li>Module MAC de référence : <b>'.$refmac_relai1.'</b></li>';
echo '<li>Module EXT de référence : <b>'.$refext_relai1.'</b></li>';
echo '<li>Température extérieure de référence : <b>'.$reftemp_relai1.'</b> degrés</li>';
echo '<li>Thermostat affilié  : </li>';
echo '<ul>';
echo '<li>Thermostat 1 : <b>'.$refmod1_relai1.'</b></li>';
echo '<li>Thermostat 2 : <b>'.$refmod2_relai1.'</b></li>';
echo '<li>Thermostat 3 : <b>'.$refmod3_relai1.'</b></li>';
echo '</ul>';
echo '</td></tr></table>';
echo '<br /></br>';

// Relai 2
echo '<h1>'.$name_relai2.' ('.$mac_relai2.') : </h1>';
echo '<table width=90%><tr><td width=100>';
echo '<img src=./'.$type_relai2.' width=100 />';
echo '</td><td>';
echo '<ul>';
echo '<li>Status Wifi : <b>'.NAWifiRssiThreshold($wifi_relai2).'</b> ('.$wifi_relai2.')</li>';
echo '<li>Firmware : <b>'.$firmware_relai2.'</b></li>';
echo '<li>Module MAC de référence : <b>'.$refmac_relai2.'</b></li>';
echo '<li>Module EXT de référence : <b>'.$refext_relai2.'</b></li>';
echo '<li>Température extérieure de référence : <b>'.$reftemp_relai2.'</b> degrés</li>';
echo '<li>Thermostat affilié  : </li>';
echo '<ul>';
echo '<li>Thermostat 1 : <b>'.$refmod1_relai2.'</b></li>';
echo '<li>Thermostat 2 : <b>'.$refmod2_relai2.'</b></li>';
echo '<li>Thermostat 3 : <b>'.$refmod3_relai2.'</b></li>';
echo '</ul>';
echo '</td></tr></table>';
echo '<br /></br>';

// Relai 3
echo '<h1>'.$name_relai3.' ('.$mac_relai3.') : </h1>';
echo '<table width=90%><tr><td width=100>';
echo '<img src=./'.$type_relai3.' width=100 />';
echo '</td><td>';
echo '<ul>';
echo '<li>Status Wifi : <b>'.NAWifiRssiThreshold($wifi_relai3).'</b> ('.$wifi_relai3.')</li>';
echo '<li>Firmware : <b>'.$firmware_relai3.'</b></li>';
echo '<li>Module MAC de référence : <b>'.$refmac_relai3.'</b></li>';
echo '<li>Module EXT de référence : <b>'.$refext_relai3.'</b></li>';
echo '<li>Température extérieure de référence : <b>'.$reftemp_relai3.'</b> degrés</li>';
echo '<li>Thermostat affilié  : </li>';
echo '<ul>';
echo '<li>Thermostat 1 : <b>'.$refmod1_relai3.'</b></li>';
echo '<li>Thermostat 2 : <b>'.$refmod2_relai3.'</b></li>';
echo '<li>Thermostat 3 : <b>'.$refmod3_relai3.'</b></li>';
echo '</ul>';
echo '</td></tr></table>';
echo '<br /></br>';
}
...
echo '<form action="http://www.histoires2familles.fr/netatmoinfo4.php" method="get" accept-charset="utf-8" id="form-login">';
